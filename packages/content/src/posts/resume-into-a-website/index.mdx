...
stub:
  A while back I designed and built my resumé in HTML. It was a fun little
  project. I’ve recently transformed the same HTML into a proper website. This
  is how I did it.
tags:
  - web development
  - html
...
About five years ago I made my resumé from HTML and hosted it on one of my
[miscellaneous domains](https://misc.alhinds.com/resume). This was pretty cool.
It gave me a bunch of flexibility and allowed me to leverage the same CSS theme
across other personal branding web projects. A nifty little feature is with the
following CSS:
...
the same. It was bugging me though that it wasn't _really_ a website. It was a
PDF pretending to be one. It wasn't:
