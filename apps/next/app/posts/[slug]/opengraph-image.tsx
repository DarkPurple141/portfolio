...
export default async ({ params }: Params) => {
  ...
  return new ImageResponse(
    (
      <div tw="flex flex-col w-full h-full items-start justify-between bg-slate-1000 px-16 py-8">
        <div tw="flex flex-col text-slate-100">
          <p tw="m-0 leading-none text-[#98c0d7]">Read article</p>
          <h1 tw="mt-2 text-4xl font-bold tracking-tight">
            {post.frontmatter.title}
          </h1>
        </div>
        <div tw="flex text-slate-300">
          <img
            tw="bg-[#98c0d7] w-13 h-13 mr-4"
